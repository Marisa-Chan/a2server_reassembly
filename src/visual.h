...
public:
	...
	void sub_40C112(); //40c112 in asm
	void sub_40C18B(); //40c18b in asm
	...
	void sub_4193E8(); //4193e8
	void sub_4194A2(); //4194a2
	void sub_41A425(); //41a425
...
public:
	...
	virtual int32_t VMethod38(); // 4c6bc0
