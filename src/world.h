...
public:
    ...
    uint16_t sub_5B5C2B(Unit* unit1, Unit* unit2); // 5B5C2B: packed distance/facing metric between two units
    ...
    int32_t sub_5AD2C1(Unit* unit, Unit* target); // 5AD2C1
    ...
    void sub_5A8CD8(Unit* unit); // 5A8CD8 — helper for sub_5AF5DC.
    void sub_5A8DBC(Unit* unit); // 5A8DBC — helper for sub_5A8CD8 (ASM).
