...
public:
    ...
    int32_t sub_52C735(uint32_t effect_bit); // 52C735: returns enchantments & (1 << effect_bit)
    uint8_t sub_52F5BB(uint8_t sphere); // 52F5BB: clamped spell power for sphere: max(0, skill_levels[sphere] + mind - 30)
